...
const ThemeChanger = ({ theme, setTheme, loading, themeConfig }) => {
    const changeTheme = (e, selectecTheme) => {
        e.preventDefault();
        document.querySelector('html').setAttribute('data-theme', selectecTheme);

        typeof window !== 'undefined' && localStorage.setItem('gitprofile-theme', selectecTheme);
