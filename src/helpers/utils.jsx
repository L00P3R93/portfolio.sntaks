...
export const getInitialTheme = (themeConfig) => {
    ...
    if(
        ...
        return localStorage.getItem('gitprofile-theme');
    }
...
export const ga = {
     ...
     * @param {string} id - The ID to be used for initialization.
     */
    initialize: (id) => {
        try{
    ...
    /**
     * Logs Specific Event Happening.
     * Sends an event to Google Analytics.
     *
     * @param {object} event - An object containing the action and params.
     *   - {string} action - The action to be tracked.
     *   - {object} params - Additional parameters for the event.
...
export const isDarkishTheme = (theme) => {
    return ['dark', 'halloween', 'forest', 'black', 'luxury', 'dracula'].includes(theme);
}
